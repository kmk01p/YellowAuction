...
public class AuctionConstants {
     ...
     * - 보통 시급 최저임금(9,620원)을 월 환산(209시간 기준 약 2,012,580원)한 뒤,
     *   실제 프로젝트 규모에 맞춰 대략 1/20 수준으로 예시 산정한 값입니다.
     * - 이 값보다 낮은 시작가는 등록 단계에서 예외를 발생시켜
     *   비정상적으로 낮은 금액 등록을 방지합니다.
     * </p>
     * --> 사용자 피드백을 통해서 최저 금액을 10만원으로 수정했습니다 !
     * <p>사용 예시:
     ...
     *   합리적인 경쟁 유도를 위해 일정 수준(예: 1만 원)으로 고정합니다.
     * </p>
     *
     * <p>사용 예시:
     * <code>
